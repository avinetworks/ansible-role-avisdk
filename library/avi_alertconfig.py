...
options:
    ...
    object_type:
        description:
            ...
            - GSLBSERVICERUNTIMEBATCH, WAFPOLICYPSMGROUP, PINGACCESSAGENT, SERVICEENGINEPOLICY, NATPOLICY, SSOPOLICY, SERVICEENGINE, DEBUGSERVICEENGINE,
            ...
            - SEAGENTSHARDCLIENTAPPMAP, SEAGENTSHARDCLIENTEVENTHISTORY, SENATSTATRUNTIME, SENATFLOWRUNTIME, SECUTIRYMGRRUNTIME, SERESOURCEPROTO,
