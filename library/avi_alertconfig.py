...
options:
    ...
    object_type:
        description:
            ...
            - GSLBSERVICERUNTIMEBATCH, WAFPOLICYPSMGROUP, PINGACCESSAGENT, NETWORKSERVICE, NATPOLICY, SSOPOLICY, PROTOCOLPARSER, TESTSEDATASTORELEVEL1,
            - TESTSEDATASTORELEVEL2, TESTSEDATASTORELEVEL3, SERVICEENGINE, DEBUGSERVICEENGINE, DEBUGCONTROLLER, DEBUGVIRTUALSERVICE, SERVICEENGINEGROUP,
            ...
            - GSLBDNSGEOUPDATE, GSLBDNSGEOCLUSTEROPS, GSLBDNSCLEANUP, GSLBSITEOPSRESYNC, IPAMDNSPROVIDERPROFILE, CUSTOMERPORTALINFO, TCPSTATRUNTIME,
