...
options:
    ...
    object_type:
        description:
            ...
            - SENETWORKSERVICERUNTIME, SEGEORUNTIME, NATPOLICYSTATS, SECURITYMGRLEARN, SECURITYMGRTOPN, SERESOURCEPROTO, SECONSUMERPROTO, SECREATEPENDINGPROTO,
            ...
            - VIDATASTORECONTENTS, VIMGRVCENTERCLOUDRUNTIME, VIVCENTERPORTGROUPS, VIVCENTERDATACENTERS, VIMGRHOSTRUNTIME, PLACEMENTGLOBALS, PORTALCONNECTOR,
            ...
            - APICAGENTINTERNAL, APICTRANSACTIONFLAP, APICGRAPHINSTANCES, APICEPGS, APICEPGEPS, APICDEVICEPKGVER, APICTENANTS, APICVMMDOMAINS, NSXCONFIGURATION,
            - NSXSGTABLE, NSXAGENTINTERNAL, NSXSGINFO, NSXSGIPS, NSXAGENTINTERNALCLI, MAXOBJECTS.
        type: str
    recommendation:
        description:
