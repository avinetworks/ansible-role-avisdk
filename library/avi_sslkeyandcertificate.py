...
short_description: SSLKeyAndCertificate Configuration
description:
...
options:
    ...
    certificate_management_profile_ref:
        description:
            - Not present. object ref CertificateManagementProfile.
        type: string
    dynamic_params:
        description:
    ...
    try:
        module = AnsibleModule(
            argument_spec=dict(
                ...
                certificate_management_profile_ref=dict(
                    type='str',
                    ),
                dynamic_params=dict(
                    type='list',
        ...
        if existing_obj:
            ...
            if changed:
                ...
                rsp = api.put(
                    'sslkeyandcertificate/%s' % obj_uuid, data=obj,
                    tenant=tenant, tenant_uuid=tenant_uuid)
        else:
            changed = True
            rsp = api.post('sslkeyandcertificate', data=obj,
                           tenant=tenant, tenant_uuid=tenant_uuid)
        if rsp is None:
