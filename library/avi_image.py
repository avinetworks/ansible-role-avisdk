...
options:
    ...
    status:
        description:
            ...
            - SYSERR_NOT_UPGRADING, SYSERR_PENDING, SYSERR_EVENT_GEN_FAILURE, SYSERR_CONFIG_PARAM_MISSING, SYSERR_BAD_REQUEST, SYSERR_TEST1, SYSERR_TEST2,
            - SYSERR_QUEUE_TRANSPORT_FAILURE, SYSERR_QUEUE_RETRY_TASK, SYSERR_DATASTORE_TRANSPORT_FAILURE, SYSERR_DATASTORE_UNKNOWN_FAILURE,
            - SYSERR_DATASTORE_OBJECT_DOES_NOT_EXIST, SYSERR_DATASTORE_REFERENCE_DOES_NOT_EXIST, SYSERR_DATASTORE_DB_LOCKED, SYSERR_DATASTORE_LOCK_FAILURE,
            - SYSERR_DATASTORE_TBL_NOT_EXIST, SYSERR_DATABASE_OBJECT_DOES_NOT_EXIST, SYSERR_SVC_COMMON_OBJECT_NOT_IN_CACHED_VIEW, SYSERR_RPC_CANCELED_BY_CLIENT,
            ...
            - SYSERR_RM_VS_SE_ATTACH_IP_IN_PROG, SYSERR_RM_LICENSE_EXCEEDED_CANNOT_SPAWN_SE, SYSERR_RM_RES_SWTICHOVER_FORCE, SYSERR_VI_MGR_SEVM_VNIC_SUCCESS,
            ...
            - SYSERR_LICENSE_ENFORCEMENT_KEY_NOT_VALID, SYSERR_SEAGENT_OBJ_INACTIVE, SYSERR_SEAGENT_OBJ_AWAITING_DP_PROGRAMMING, SYSERR_SEAGENT_OBJ_ACTIVE,
            ...
            - SYSERR_SEAGENT_OBJ_NOT_FOUND, SYSERR_SEAGENT_VS_NOT_FOUND, SYSERR_SEAGENT_VS_VRF_ERROR, SYSERR_SEAGENT_VS_SELIST_LIMIT_ERROR,
            - SYSERR_SEAGENT_VS_SELIST_SE_INTF_ERROR, SYSERR_SEAGENT_VS_CHILD_PARENT_UUID_MISSING, SYSERR_SEDP_PARENT_VS_NOT_EXIST_FOR_CHILD,
            - SYSERR_SEAGENT_TENANT_CREATE_FAILED, SYSERR_SEAGENT_TENANT_UPDATE_FAILED, SYSERR_SEAGENT_VS_INTERFACE_ERROR, SYSERR_SEDP_VNIC_CREATION_FAILURE,
            ...
            - SYSERR_SEDP_VNIC_VLAN_FILTER_REMOVE_FAILURE, SYSERR_SEDP_VNIC_UNKNOWN_MSG_TYPE, SYSERR_GSLB_INVALID_MTYPE, SYSERR_GSLB_INVALID_SITE_CREDENTIALS,
            - SYSERR_GSLB_OBJECT_NOT_FOUND, SYSERR_GSLB_INVALID_OPS, SYSERR_GSLB_PARTIAL_SUCCESS, SYSERR_GSLB_FQDN_CONFLICT, SYSERR_GSLB_CLEANUP_IN_PROGRESS,
            - SYSERR_GSLB_METHOD_NOP, SYSERR_GSLB_API_NOT_SUPPORTED_FOR_UNFEDERATED_OBJECTS, SYSERR_GSLB_STATEDB_ERR,
            - SYSERR_GSLB_SERVICE_MEMBER_VIPS_NOT_IN_SYNC, SYSERR_GSLB_SERVICE_MEMBER_DISABLED, SYSERR_GSLB_SITE_DISABLED, SYSERR_GSLB_SERVICE_DISABLED,
            - SYSERR_GSLB_HM_PROXY_DOWN, SYSERR_GSLB_DNS_DISABLED, SYSERR_GSLB_SERVICE_NON_AVI_VIP_INFO_UNAVAILABLE,
            ...
            - SYSERR_GSLB_SERVICE_POOL_DISABLED, SYSERR_GSLB_SERVICE_CREATE_FAILED, SYSERR_GSLB_SERVICE_UPDATE_FAILED, SYSERR_DNS_POLICY_CREATE_FAIL,
            - SYSERR_DNS_POLICY_UPDATE_FAIL, SYSERR_LCM_CORE_NOT_COPIED_DUE_TO_MAX_LIMIT, SYSERR_LCM_CORE_NOT_COPIED_INSUFFICIENT_DISK_SIZE,
            - SYSERR_LCM_SKIP_SIMILAR_CORE, SYSERR_LCM_CORE_NOT_COPIED_DUE_TO_ERRORS, SYSERR_LCM_STOP, SYSERR_POOL_SERVER_CAPEST_BREACHED,
            - SYSERR_POOL_CREATE_FAILED, SYSERR_POOL_UPDATE_FAILED_INCONSISTENT, SYSERR_POOL_UPDATE_FAILED, SYSERR_POOL_SERVER_STATE_UPDATE_FAILED,
            - SYSERR_POOL_UPDATE_SERVER_FAILED, SYSERR_POOL_UPDATE_LB_ALGO_NO_STATE, SYSERR_SHM_HASH_INSERT_FAILED, SYSERR_SE_RPC_PROXY_STREAM_NOT_CONNECTED,
            - SYSERR_SE_RPC_PROXY_STREAM_WRITE_FAILED, SYSERR_SE_RPC_PROXY_UNABLE_TO_FIND_SYNC_RPC, SYSERR_PRST_PROF_OBJECT_TYPE_MISMATCH,
            - SYSERR_PRST_PROF_OBJECT_NOT_FOUND, SYSERR_PRST_PROF_NULL, SYSERR_PRST_PROF_OBJECT_PRESENT, SYSERR_MS_OBJECT_EXISTS, SYSERR_MS_OBJECT_NOT_FOUND,
            - SYSERR_MS_GRP_OBJECT_EXISTS, SYSERR_MS_GRP_OBJECT_NOT_FOUND, SYSERR_HTTP_POLICY_CREATE_FAILED, SYSERR_HTTP_POLICY_CREATE_EXISTS,
            - SYSERR_HTTP_POLICY_CREATE_SHM_INSERT, SYSERR_HTTP_POLICY_UPDATE_FAILED, SYSERR_STR_GRP_REGISTER_INVAL, SYSERR_STR_GRP_DEREGISTER_INVAL,
            - SYSERR_AG_CREATE_POST_FAILED, SYSERR_AG_CREATE_PRE_FAILED, SYSERR_AG_UPDATE_FAILED, SYSERR_APP_PROF_UPDATE_TYPE_MISMATCH,
            - SYSERR_APP_PROF_CREATE_INVALID_TYPE, SYSERR_APP_PROF_UPDATE_PRESERVE_CLIENT_IP_CHANGED, SYSERR_APP_PROF_NOT_FOUND,
            - SYSERR_POOL_GRP_MEMBER_NOT_FOUND, SYSERR_POOL_GRP_UPDATE_FAILED, SYSERR_POOL_GRP_CREATE_FAILED, SYSERR_POOL_GRP_UPDATE_FAILED_INCONSISTENT,
            - SYSERR_L4PS_CONNPOL_POOL_FAILED, SYSERR_L4PS_CONNPOL_POOL_GRP_FAILED, SYSERR_L4PS_CONNPOL_IP_GRP_FAILED, SYSERR_L4PS_CREATE_FAILED,
            - SYSERR_ANT_PROF_NOT_FOUND, SYSERR_LB_CHASH_INVALID_TYPE, SYSERR_SEC_POLICY_NOT_FOUND, SYSERR_TECH_SUPPORT_COLLECTION_NOT_DONE,
            - SYSERR_TECH_SUPPORT_COLLECTION_SUCCESS, SYSERR_TECH_SUPPORT_COLLECTION_STARTED, SYSERR_TECH_SUPPORT_COLLECTION_ONGOING,
            - SYSERR_TECH_SUPPORT_COLLECTION_IN_PROGRESS, SYSERR_TECH_SUPPORT_COLLECTION_SUCCESS_WITH_ERRORS, SYSERR_TECH_SUPPORT_COLLECTION_ABORTED,
            - SYSERR_TECH_SUPPORT_COLLECTION_STATUS_FILE_NOT_FOUND, SYSERR_TECH_SUPPORT_INVALID_FILENAME, SYSERR_TECH_SUPPORT_COLLECTION_STATUS_IN_PROGRESS,
            - SYSERR_TECH_SUPPORT_INPUT_INVALID_LEVEL, SYSERR_TECH_SUPPORT_INPUT_INVALID_SLUG, SYSERR_DATASCRIPT_FAILED, SYSERR_NET_PROF_NOT_FOUND,
            - SYSERR_PORTAL_FILE_UPLOAD_IN_PROGRESS, SYSERR_PORTAL_FILE_UPLOAD_SUCCESS, SYSERR_PORTAL_FILE_UPLOAD_FAILED, SYSERR_PORTAL_FILE_UPLOAD_STARTED,
            - SYSERR_AVI_CLOUD_CASE_ID_MISSING, SYSERR_AVI_CLOUD_ASSET_ID_MISSING, SYSERR_AVI_CLOUD_AUTH_FAILURE, SYSERR_AVI_CLOUD_INTERNAL_ERROR,
            - SYSERR_AVI_CLOUD_DISCONNECTED, SYSERR_AVI_CLOUD_DEREGISTERED, SYSERR_AVI_CLOUD_CANNOT_READ_RESP, SYSERR_AVI_CLOUD_CONTROLLER_ALREADY_REGISTERED,
            - SYSERR_AVI_CLOUD_REG_SESSION_NOT_SET, SYSERR_AVI_CLOUD_CLIENT_TIME_OUT, SYSERR_AVI_CLOUD_CONN_REFUSED, SYSERR_PORTAL_CONNECTOR_HTTP_CLIENT_ERROR,
            - SYSERR_AVI_CLOUD_RESOURCE_NOT_FOUND, SYSERR_AVI_CLOUD_QUERY_PARAM_VALUE_NOT_SUPPORTED, SYSERR_AVI_CLOUD_QUERY_PARAM_NOT_SUPPORTED,
            - SYSERR_PORTAL_FILE_UPLOAD_CONFLICT, SYSERR_PORTAL_CONNECTOR_INTERNAL_ERROR, SYSERR_AVI_CLOUD_PROXY_AUTH_FAILURE,
            - SYSERR_AVI_CLOUD_LOGIN_URL_NOT_FOUND, SYSERR_PORTAL_CONNECTOR_PROXY_CONFIG_PARSE_FAILURE, SYSERR_AVI_CLOUD_LOGIN_REQ_FAILED,
            - SYSERR_AVI_CLOUD_REG_FAILED, SYSERR_PORTAL_CONNECTOR_FAILED_TO_SAVE, SYSERR_AVI_CLOUD_DEREG_FAILED, SYSERR_AVI_CLOUD_MALFORMED_PAYLOAD,
            - SYSERR_AVI_CLOUD_CASE_GET_FAILED, SYSERR_AVI_CLOUD_CASE_CREATE_FAILED, SYSERR_AVI_CLOUD_CASES_GET_FAILED, SYSERR_AVI_CLOUD_CASE_UPDATE_FAILED,
            - SYSERR_AVI_CLOUD_STATUS_REQ_FAILED, SYSERR_AVI_CLOUD_CRS_DOWNLOAD_FAILED, SYSERR_AVI_CLOUD_CRS_DEPLOY_FAILED, SYSERR_AVI_CLOUD_CRS_DATA_NOT_FOUND,
            - SYSERR_PORTAL_CONN_DATASTORE_ERROR, SYSERR_AVI_CLOUD_CRS_AUTO_DEPLOY_MALFORMED_URL, SYSERR_AVI_CLOUD_CRS_DOWNLOAD_SIG_MISMATCH,
            - SYSERR_AVI_CLOUD_CRS_DOWNLOAD_FORBIDDEN, SYSERR_PORTAL_CONNECTOR_DATABASE_ERROR, SYSERR_PORTAL_CONNECTOR_AVI_CLIENT_ERROR,
            - SYSERR_CRS_AUTO_DEPLOY_SUCCESS, SYSERR_PORTAL_CONNECTOR_EMPTY_METADATA, SYSERR_UPGRADE_SYSTEM_STARTED, SYSERR_UPGRADE_CONTROLLER_STARTED,
            - SYSERR_UPGRADE_SEGROUP_STARTED, SYSERR_RESUME_SEGROUP_STARTED, SYSERR_PATCH_SYSTEM_STARTED, SYSERR_PATCH_CONTROLLER_STARTED,
            - SYSERR_PATCH_SEGROUP_STARTED, SYSERR_PATCHSEGROUP_RESUME_STARTED, SYSERR_ROLLBACK_SYSTEM_STARTED, SYSERR_ROLLBACK_CONTROLLER_STARTED,
            - SYSERR_ROLLBACK_SEGROUP_STARTED, SYSERR_ROLLBACKPATCH_SYSTEM_STARTED, SYSERR_ROLLBACKPATCH_CONTROLLER_STARTED,
            - SYSERR_ROLLBACKPATCH_SEGROUP_STARTED, SYSERR_UPGRADE_OPS_VS_DISRUPTION_WARNINGS, SYSERR_UPGRADE_OPS_IN_PROGRESS, SYSERR_UPGRADE_OPS_CHECK_LICENSE,
            - SYSERR_UPGRADE_OPS_CHECK_CLUSTER_STATE, SYSERR_UPGRADE_OPS_CHECK_CLUSTER_DISK_SPACE, SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_INPROGRESS,
            - SYSERR_UPGRADE_OPS_CHECK_VERSION_COMPATIBILITY, SYSERR_UPGRADE_OPS_CHECK_SE_REACHABILITY, SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_CLOUD_READY,
            - SYSERR_UPGRADE_OPS_CHECK_SE_DISK_SPACE, SYSERR_UPGRADE_OPS_CHECK_VS_DISRUPUTION, SYSERR_UPGRADE_OPS_CHECK_ROLLBACK_BASICS,
            - SYSERR_UPGRADE_OPS_CHECK_CONTROLLER_VERSION_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_SE_VERSION_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_CONTROLLER_ROLLBACK,
            - SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_SYSTEM_ROLLBACK, SYSERR_UPGRADE_OPS_CHECK_IMAGE_VERSION,
            - SYSERR_UPGRADE_OPS_CHECK_DOCKER_DISK_SPACE, SYSERR_UPGRADE_OPS_CHECK_ACTIVE_VERSIONS, SYSERR_UPGRADE_OPS_CHECK_BACKUP,
            - SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_ERROR_RECOVERY, SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_SUSPENDED, SYSERR_UPGRADE_OPS_CHECK_SYSTEM_FLAG,
            - SYSERR_UPGRADE_OPS_PREVIEW_RESPONSE, SYSERR_UPGRADE_OPS_CHECK_PREVIOUS_PARTITION_COMPATIBILITY, SYSERR_UPGRADE_OPS_CHECK_IMAGE_COMPATIBILITY,
            - SYSERR_UPGRADE_OPS_CHECK_CONTROLLER_PATCH_COMPATIBILITY, SYSERR_UPGRADE_OPS_CHECK_SE_PATCH_COMPATIBILITY, SYSERR_UPGRADE_OPS_CHECK_SE_ROLLBACK_V1,
            - SYSERR_UPGRADE_OPS_CHECK_ALERTS, SYSERR_MC_UPGRADE_LICENSE_ERR, SYSERR_MC_UPGRADE_CLUSTER_NOT_READY, SYSERR_MC_DISK_INSUFFICIENT_ERR,
