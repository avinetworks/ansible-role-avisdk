...
short_description: Module for setup of VsGs Avi RESTful Object
description:
    - This module is used to configure VsGs object
...
- name: Example to create VsGs object
  avi_vsgs:
...
RETURN = '''
obj:
    description: VsGs (api/vsgs) object
...
def main():
    argument_specs = dict(
        ...
        geodb_uuid=dict(type='str',),
        gs_uuid=dict(type='str',),
    ...
    return avi_ansible_api(module, 'vsgs',
                           set())
