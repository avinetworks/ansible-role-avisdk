...
options:
    ...
    status:
        description:
            ...
            - SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_ERROR_RECOVERY, SYSERR_UPGRADE_OPS_CHECK_SE_GROUP_SUSPENDED, SYSERR_UPGRADE_OPS_SYSTEM_FLAG,
            - SYSERR_UPGRADE_OPS_PREVIEW_RESPONSE, SYSERR_PREVIOUS_PARTITION_COMPATIBILITY, SYSERR_IMAGE_COMPATIBILITY, SYSERR_CONTROLLER_PATCH_COMPATIBILITY,
            - SYSERR_SE_PATCH_COMPATIBILITY, SYSERR_SE_ROLLBACK_V1, SYSERR_ALERTS, SYSERR_MC_UPGRADE_LICENSE_ERR, SYSERR_MC_UPGRADE_CLUSTER_NOT_READY,
            ...
            - SYSERR_MC_SE_ROLLBACK_V1_ERR, SYSERR_MC_ALERTS.
            - Field introduced in 18.2.6.
        type: str
    tenant_ref:
        description:
