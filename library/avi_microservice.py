...
short_description: Module for setup of MicroService Avi RESTful Object
description:
...
EXAMPLES = """
- name: Example to create MicroService object
  avi_microservice:
...
def main():
    argument_specs = dict(
        ...
        ip_list=dict(type='bool',),
        name=dict(type='str', required=True),
        orchestrator_name=dict(type='str', required=True),
